...
namespace detail {
    ...
    inline namespace filter {
        ...
        struct filter_list_<T, Args...> {
            template <typename... TArgs>
            using type =
                typename discharge_<typename compatibility_helper_filter_<T, TArgs...>::type>::template into<typename filter_list_<Args...>::template type>;
        };
    ...
    inline namespace apply_op {
        ...
        struct both {
            template <typename T, typename R>
            constexpr bool operator()(T, R) const
            {
        ...
        struct only_one {
            ...
            constexpr bool operator()(T, R) const
            {
                return !(T::value && R::value) && (T::value || R::value);
            }
        };
